# Contributing to ml-decorators

ml-decorators welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-decorators, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **ml-decorators Version** - is it a named version or from our master branch
...
Fork the project [on GitHub](https://github.com/grtjn/ml-decorators/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-decorators.git
$ cd ml-decorators
$ git remote add upstream git://github.com/grtjn/ml-decorators.git
```
...
Go to https://github.com/username/ml-decorators and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-decorators/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-decorators/issues
